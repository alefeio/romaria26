...
const ITEMS: Item[] = [
  ...
  { href: "/admin/colaboradores", label: "Colaboradores", adminOrMaster: true, category: "Operação" },
  ...
  { href: "/admin/site/galeria", label: "Galeria (fotos/vídeos)", adminOrMaster: true, category: "Site" },
