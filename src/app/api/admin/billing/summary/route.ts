...
export async function GET(request: Request) {
  ...
  try {
    ...
    const unpaid = new Prisma.Decimal(sumDue.toString()).sub(new Prisma.Decimal(sumPaid.toString()));
    ...
    console.error("[api/admin/billing/summary]", e);
    return jsonErr("BILLING_SUMMARY_FAILED", "Não foi possível carregar o faturamento.", 500);
  }
}
